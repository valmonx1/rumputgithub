  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Worker Registration</li>
          </ol>
      ...
      <div class="card card-register mx-auto mt-5">
        ...
        <div class="card-body">
          <form id="form1" name="form1" method="POST" action="worker_insert.php" onsubmit="return validation()">
		  <div class="form-group">
		  <div class="form-row">
		  <div class="col-md-6">
              <div class="form-label-group">
                <input type="text" id="workerid" name="workerid" class="form-control" value="<?php $a = substr (uniqid('W'),0,1);
echo $a; echo substr(uniqid(rand(), true),0,5);?>" readonly >
			...
			<div class="form-group">
              <div class="form-label-group">
                <input type="tel" id="telno" name="telno" class="form-control" placeholder="Telephone Number" required="required">
